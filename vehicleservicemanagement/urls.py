...
urlpatterns = [
    ...
    path('customer-add-request',views.customer_add_request_view,name='customer-add-request'),
     path('customer-recommend-request',views.customer_recommend_request_view,name='customer-recommend-request'),
    ...
    path('teams/', views.team_page, name='teams'),
    ...
    path('blogpost/', views.blogpost_page, name='blogpost'),
    path('blogpost1/', views.blogpost1_page, name='blogpost1'),
    path('blogpost2/', views.blogpost2_page, name='blogpost2'),
    path('request-page/', views.request_page, name='request-page'),
